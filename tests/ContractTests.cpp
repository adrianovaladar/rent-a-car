...
TEST_F(ContractTests, StartContractWithoutCustomers) {
    ...
    startContract(nullptr, outputFile, contracts.data(), customers.data(), vehicles.data(), &quantityContracts, quantityCustomers, vehicles.size());
...
TEST_F(ContractTests, StartContractWithoutVehicles) {
    ...
    startContract(nullptr, outputFile, contracts.data(), customers.data(), vehicles.data(), &quantityContracts, customers.size(), quantityVehicles);
    EXPECT_EQ(quantityContracts, 0);
}

TEST_F(ContractTests, StartContractMaxContractsReached) {
    size_t quantityContracts {contracts.size()};
    startContract(nullptr, outputFile, contracts.data(), customers.data(), vehicles.data(), &quantityContracts, customers.size(), vehicles.size());
...
TEST_F(ContractTests, StartContractRiskyClient) {
    ...
    startContract(file, outputFile, contracts.data(), customers.data(), vehicles.data(), &quantityContracts, customers.size(), vehicles.size());
    EXPECT_EQ(quantityContracts, 0);
}
...
TEST_F(ContractTests, ManageContractWithoutContracts) {
    ...
    size_t quantityContracts {};
    manageContractByVehicleCodeAndStartDate(file, outputFile, contracts.data(), vehicles.data(), customers.data(), &quantityContracts, vehicles.size(), customers.size());
    EXPECT_EQ(quantityContracts, 0);
}

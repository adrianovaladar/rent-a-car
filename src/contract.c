...
void startContract(contract *contracts, customer *customers, vehicle *vehicles, const size_t quantityCustomers, const size_t quantityVehicles, size_t *quantityContracts) {
